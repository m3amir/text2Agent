# COGNITO - TEMPORARILY COMMENTED OUT FOR TESTING
# This file has been temporarily commented out for faster testing
# To restore, uncomment all the resource blocks below

# Uncomment the block below to restore Cognito functionality:
# 
# Cognito User Pool
